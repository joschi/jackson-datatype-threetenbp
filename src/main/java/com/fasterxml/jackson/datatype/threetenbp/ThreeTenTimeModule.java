...
import com.fasterxml.jackson.datatype.threetenbp.deser.*;
import com.fasterxml.jackson.datatype.threetenbp.deser.key.*;
import com.fasterxml.jackson.datatype.threetenbp.ser.*;
...
public final class ThreeTenTimeModule
    extends SimpleModule
{
     ...
     * @since 2.16
     */
    private JacksonFeatureSet<ThreeTenTimeFeature> _features;

    public ThreeTenTimeModule()
    {
        super(PackageVersion.VERSION);
        _features = JacksonFeatureSet.fromDefaults(ThreeTenTimeFeature.values());
    }

    public ThreeTenTimeModule enable(ThreeTenTimeFeature f) {
        _features = _features.with(f);
        return this;
    }

    public ThreeTenTimeModule disable(ThreeTenTimeFeature f) {
    ...
    public void setupModule(SetupContext context) {
        ...
        desers.addDeserializer(Period.class, ThreeTenStringParsableDeserializer.PERIOD);
        ...
        desers.addDeserializer(ZoneId.class, ThreeTenStringParsableDeserializer.ZONE_ID);
        desers.addDeserializer(ZoneOffset.class, ThreeTenStringParsableDeserializer.ZONE_OFFSET);

        context.addDeserializers(desers);
        
        final boolean oneBasedMonthEnabled = _features.isEnabled(ThreeTenTimeFeature.ONE_BASED_MONTHS);

        context.addBeanDeserializerModifier(new ThreeTenTimeDeserializerModifier(oneBasedMonthEnabled));
        context.addBeanSerializerModifier(new ThreeTenTimeSerializerModifier(oneBasedMonthEnabled));
