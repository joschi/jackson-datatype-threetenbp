...
import com.fasterxml.jackson.datatype.threetenbp.ser.ZonedDateTimeWithZoneIdSerializer;
...
/**
 * Older version of {@link ThreeTenTimeModule} which was the default choice up to
 * Jackson 2.15, but was obsoleted in 2.18 by {@link ThreeTenTimeModule}.
 * Functionality does not differ between the two modules (at least in 2.18),
 * so Javadocs for {@link ThreeTenTimeModule} may be consulted for functionality
 * available.
 * The default settings do, however, such that
 *<ul>
 * <li>New {@link ThreeTenTimeModule} uses same standard settings to default to
 ...
 *  </li>
 *  <li>Old {@link ThreeTenModule} defaults to serialization WITH Timezone Ids (to support
 *    round-trippability of values when using JSR-310 types and Jackson)
 *   </li>
 * </ul>
 * Note that it is, then, possible to upgrade to {@link ThreeTenTimeModule} by simply
 ...
 * @see com.fasterxml.jackson.datatype.threetenbp.ThreeTenTimeModule
 *
 * @deprecated Replaced by {@link ThreeTenTimeModule} since Jackson 2.7, see above for
...
public final class ThreeTenModule extends SimpleModule {
    ...
    private static ZonedDateTimeWithZoneIdSerializer _zonedWithZoneId() {
        return com.fasterxml.jackson.datatype.threetenbp.ser.ZonedDateTimeWithZoneIdSerializer.INSTANCE;
    }
